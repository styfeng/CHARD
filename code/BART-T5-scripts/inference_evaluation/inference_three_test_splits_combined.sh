...
FILES=("HF_training_data/combined/combined_test_HF.json" "HF_training_data/combined/combined_test-seen_HF.json" "HF_training_data/combined/combined_test-unseen_HF.json")
