...
base_folder = f"trained_T5_models/T5-{size}_{default_seed}_{model_type}_{lr}" #IMPORTANT: model folder that contains the checkpoint folders
...
model_string = f"T5-{size}_{default_seed}_{model_type}_{lr}" #string describing model and its parameters to be used in the variables below
...
out_BERTScore_name = f"{base_folder}/test-{testset_type}_generated_{model_string}_cp{checkpoint}_BERTScores.json" #IMPORTANT: file to save individual BERTScore results to
...
out_diversity_name = f"{base_folder}/test-{testset_type}_generated_{model_string}_cp{checkpoint}_diversity.json" #IMPORTANT: file to save individual length + diversity results to
