...
FILES=("HF_training_data/treatment/treatment_test_HF.json" "HF_training_data/treatment/treatment_test-seen_HF.json" "HF_training_data/treatment/treatment_test-unseen_HF.json")
