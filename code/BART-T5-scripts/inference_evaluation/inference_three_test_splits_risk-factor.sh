...
FILES=("HF_training_data/risk-factor/risk-factor_test_HF.json" "HF_training_data/risk-factor/risk-factor_test-seen_HF.json" "HF_training_data/risk-factor/risk-factor_test-unseen_HF.json")
